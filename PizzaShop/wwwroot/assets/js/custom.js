jQuery(function ($) {
    ...
    $('.slider-for').slick({
        ...
        autoplay:true,
        centerPadding:'0px',
        prevArrow:"<button type='button' class='slick-prev pull-right'><i class='bx bx-right-arrow-alt' aria-hidden='true'></i></button>",
        nextArrow:"<button type='button' class='slick-next pull-left'><i class='bx bx-left-arrow-alt' aria-hidden='true'></i></button>"
    });
    $('.slider-nav').slick({
		rtl:true,
        slidesToShow:3,
